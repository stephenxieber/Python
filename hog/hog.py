...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    # Both Players' scores must be larger than one
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if gain > previous_high:
            ...
            return announce_highest(who, gain, current_score) # This return updates the previous_high
        return announce_highest(who, previous_high, current_score) # This return maintains the previous_high
    return say
    # END PROBLEM 7
...
def make_averaged(fn, num_samples=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def result(*args):# *args可以为空
        count = 0
        average = 0
        while count < num_samples:
            average += fn(*args)#对于make_test_dice()来说，fn的参数其实是为空; 对于roll_dice(num_rolls, dice=sixsided)来说就需要两个参数
            count += 1
        average /= num_samples
        return average
    return result
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for num_rolls in range(1, 11):
        expect_score = averaged_dice(num_rolls, dice)
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    score_after_bacon = score + free_bacon(opponent_score) # Replace this statement
